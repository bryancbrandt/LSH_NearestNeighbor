...
class MinHeap:
    ...
    def __getParentPos(self, childPos: object) -> object:
        if childPos % 2 == 0:
            return childPos // 2 - 1
        return childPos // 2

    # Method Checks whether parentObj is Greater than child object.
    ...
    def poll(self):
        ...
        return heapObjectTop.value, heapObjectTop.key
